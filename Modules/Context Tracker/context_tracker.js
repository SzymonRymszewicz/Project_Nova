	...
	function ensureTrackerStructure(host) {
		...
		host.innerHTML = `
			...
			<div class="context-tracker-tooltip">
				...
				<div class="context-tooltip-item" data-row="iams"><span class="context-tooltip-label">Chat Messages(IAMs):</span><span class="context-tooltip-value"><span data-value="iams">0</span> <span class="context-tooltip-percent" data-percent="iams">(0.0%)</span></span></div>
